...
const mockNavigation = {
  ...
  jest.mock('../services/storage', () => ({
    StorageService: {
      clearAll: jest.fn().mockImplementation(() => new Promise(resolve => setTimeout(resolve, 100))),
      setCryptoCurrencies: jest.fn().mockImplementation(() => new Promise(resolve => setTimeout(resolve, 100))),
      setFiatCurrencies: jest.fn().mockImplementation(() => new Promise(resolve => setTimeout(resolve, 100))),
    },
  }));
